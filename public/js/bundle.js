...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZW50YW5nbGVkb25lIiwiYSI6ImNrZW9kcGQ0dzBvcHozMHQ1eW11Nm9qNWUifQ.iswmL937hznP2jcyRx2C4Q";
  var map = new mapboxgl.Map({
    container: 'map',
    style: "mapbox://styles/entangledone/ckesxlf8877by19ny7alxbczj",
...
var stripe = Stripe('pk_test_Uinl9l2IPTmEvf5RZgoupGKt');
...
var userPasswordForm = document.querySelector('.form-user-password'); // if (userPasswordForm) console.log('index: userPasswordForm confirmed');
// if (!userPasswordForm) console.log('index: userPasswordForm not found');
